...
- config_sets:
  ...
  - fsl_flexcan:
    - can_config:
      ...
      - enableNonCorrectableErrorEnterFreezeConfig: 'putInFreeze'
      - timingConfig:
        - propSeg: '2'
        - phaseSeg1: '4'
        - phaseSeg2: '3'
...
static void CAN3_init(void) {
  ...
  /* Enable interrupt CAN3_ERROR_IRQn request in the NVIC. */
  EnableIRQ(CAN3_ERROR_IRQN);
}
